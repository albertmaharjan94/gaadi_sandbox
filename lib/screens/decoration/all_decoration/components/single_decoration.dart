...
class SingleDecoration extends StatefulWidget {
  SingleDecoration(
      {Key? key,
  ...
  @override
  _SingleDecorationState createState() => _SingleDecorationState();
}

class _SingleDecorationState extends State<SingleDecoration> {
  int _current = 0;
