...
class RegisterTest extends StatefulWidget {
  ...
  const RegisterTest({Key? key, required this.changeIndex}) : super(key: key);
  @override
  _RegisterTestState createState() => _RegisterTestState();
}
...
class _RegisterTestState extends State<RegisterTest> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        onWillPop: () {
          widget.changeIndex(LoginTest.routeIndex);
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                ...
                                RegExp regExp = new RegExp(patttern.toString());
                                if (value == "") {
  ...
  void _registration(data) async {
    ...
    localStorage.setString('RegisterTest', '0');
    ...
    // try {
    //   print(data);
    //   res = await CallApi().postData(data, 'RegisterTest');
