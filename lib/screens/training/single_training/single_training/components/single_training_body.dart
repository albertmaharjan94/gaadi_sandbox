...
class SingleTrainingBody extends StatefulWidget {
  SingleTrainingBody({Key? key}) : super(key: key);
...
""";
  ...
  @override
  _SingleTrainingBodyState createState() => _SingleTrainingBodyState();
}

class _SingleTrainingBodyState extends State<SingleTrainingBody>
    with TickerProviderStateMixin<SingleTrainingBody> {
  @override
